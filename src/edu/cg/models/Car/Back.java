...
public class Back implements IRenderable, IIntersectable {
	...
	private PairOfPipes pairOfPipes = new PairOfPipes();
	...
	public void render(GL2 gl) {
		...
		gl.glPushMatrix();
		//Add pipes in the back of the car
		pairOfPipes.render(gl);
		gl.glPopMatrix();
	}
	...
	public List<BoundingSphere> getBoundingSpheres() {
		...
		double radius = Specification.REAR_SPHERE_RADIUS;
		Point center = new Point(0.0,	Specification.B_HEIGHT / 2 , 0.0);
