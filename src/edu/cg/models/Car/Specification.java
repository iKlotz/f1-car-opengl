...
public class Specification {
	...
	// --> Sphere Radius
	public static final double FRONT_SPHERE_RADIUS = Math.sqrt(Math.pow(F_LENGTH / 2, 2.0) + Math.pow(F_DEPTH / 2, 2.0) + Math.pow(F_HEIGHT / 2, 2.0));
	public static final double REAR_SPHERE_RADIUS = Math.sqrt(Math.pow(B_LENGTH / 2, 2.0) + 
			Math.pow(B_DEPTH / 2, 2.0) + Math.pow(B_HEIGHT / 2, 2.0));
	public static final double CENTER_SPHERE_RADIUS = Math.sqrt(Math.pow(C_LENGTH / 2, 2.0) + Math.pow(C_DEPTH / 2, 2.0) + Math.pow(C_HEIGHT / 2, 2.0));
	public static final double GLOBAL_SPHERE_RADIUS = F_LENGTH + F_BUMPER_LENGTH;
